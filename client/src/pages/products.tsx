      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            className="max-w-6xl mx-auto bg-gradient-to-br from-[#2D3B2D] to-[#1a2a1a] rounded-[2rem] p-6 md:p-10 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-right">
                <span className="inline-block bg-[#BC7C5F] text-white text-base px-5 py-2 rounded-full mb-5 uppercase tracking-wider font-bold">Coming Soon</span>
                <div className="flex justify-center md:justify-end mb-5">
                  <TreePine className="w-16 h-16 text-[#BC7C5F]" />
                </div>
                <h3 className="font-serif text-5xl md:text-6xl text-white mb-4">The Lumberjack</h3>
