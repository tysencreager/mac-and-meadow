          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-10">
              ...
              <div className="flex-1 text-center md:text-left order-2 md:order-1">
                <span className="inline-block bg-[#BC7C5F] text-white text-sm sm:text-base px-4 sm:px-5 py-2 rounded-full mb-4 sm:mb-5 uppercase tracking-wider font-bold">Coming Soon</span>
                <div className="flex justify-center md:justify-start mb-4 sm:mb-5">
                  <TreePine className="w-12 h-12 sm:w-16 sm:h-16 text-[#BC7C5F]" />
                </div>
                <h3 className="font-serif text-4xl sm:text-5xl md:text-6xl text-white mb-3 sm:mb-4">The Lumberjack</h3>
              ...
              <div className="w-full md:w-2/5 flex-shrink-0 order-1 md:order-2">
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="rounded-[1.5rem] shadow-xl w-full h-[280px] sm:h-[320px] md:h-[400px] object-cover object-top"
                />
              </div>
            </div>
          </motion.div>
