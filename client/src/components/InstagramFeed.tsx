    ...
    <section className="py-24 bg-[#F7F4EF] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        {showHeader && (
          ...
          >
            <span className="text-[#4C5246] font-serif italic text-xl">{subtitle}</span>
            <h2 className="font-serif text-4xl md:text-5xl text-[#312213] mt-4">{title}</h2>
          </motion.div>
        )}
          ...
          {isConfigured ? (
            ...
            <div className="bg-white rounded-[2rem] p-12 shadow-xl text-center">
              <div className="max-w-md mx-auto space-y-6">
                ...
                <h3 className="font-serif text-2xl text-[#312213]">@macandmeadowco</h3>
        ...
        {isConfigured && (
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#4C5246] text-white px-8 py-4 rounded-full font-medium hover:bg-[#4C5246]/90 transition-colors shadow-lg"
            >
              <Instagram className="w-5 h-5" />
